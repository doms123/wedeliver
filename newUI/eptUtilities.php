...
{
    $userDetails=DB::query("select userId, fbId, fbIntId, fbFirstName, fbLastName, fbEmail, isContactId, isEmail, platform, appName, appDomainName, accessToken, refreshToken, expiresAt, tokenType, scope, authhash from  tblEptUsers u");
    return $userDetails;
}
...
{
    $userDetails=DB::queryFirstRow("select userId, fbId, fbIntId, fbFirstName, fbLastName, fbEmail, isContactId, isEmail, platform, appName, appDomainName, accessToken, refreshToken, expiresAt, tokenType, scope, authhash from  tblEptUsers u where userId=%s", $uID);
    return $userDetails;
}
...
function navigationMenu($userProfile, $infusionsoft)
{
   
   $userHtmlString = showUserProfile($userProfile, $infusionsoft);
    //echo 'user profile:>>' . $userHtmlString;
    $retString='
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="?op=showstatus"><i class="fa fa-fw fa-eye"></i> Show Status</a>
                </li>
                <li>
                ...
                <li>
                    <a href="ept.php"><i class="fa fa-fw fa-gears"></i> Admin Settings</a>
                </li>  
            </ul>
        </div>
        <!-- /.sidebar-collapse -->
...
function multipleEPTCards()
{
    ...
    $retString=sprintf('%s %s %s %s',   
    eptCards( 'primary', 'fa fa-comments fa-5x', '271', 'Contacts'),
    eptCards( 'green', 'fa fa-check-square-o ept-dash-icon', '1', 'Marketable'),  
    eptCards( 'yellow', 'fa fa-thumbs-o-down ept-dash-icon', '1', 'Opted Out'), 
    eptCards( 'red', 'fa fa-remove ept-dash-icon', '0', 'Bounced')
    );   
    return $retString;
}
